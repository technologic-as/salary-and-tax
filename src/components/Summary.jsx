  ...
  return (
    <Section header={formatMessage(messages.header)} expanded>
      <Table>
        <TableBody>
          <TaxRow
            description={formatMessage(messages.turnover)}
            sum={formatCurrency(turnover)}
          />
          <TaxRow
          ...
          <TaxRow
            ...
            amount={formatCurrency(afterTax)}
          />
          <TaxRow
            description={formatMessage(messages.dividends)}
            amount={formatCurrency(afterDividendsTax)}
          />
          <TaxRow
            description={formatMessage(messages.totalIncome)}
            sum={formatCurrency(afterTotal)}
          />
        </TableBody>
      </Table>
    </Section>
